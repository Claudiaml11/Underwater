...
GamePlayManager = {
    ...
    create: function () {
        ...
        for (var i = 0; i < AMOUNT_DIAMONDS; i++) {
            ...
            while (this.isOverlapingOtherDiamond(i, rectCurrentDiamond) || this.isRectanglesOverlaping(rectHorse, rectCurrentDiamond)) {
                diamond.x = game.rnd.integerInRange(50, 1050);
                diamond.y = game.rnd.integerInRange(50, 600);
    ...
    isRectanglesOverlaping: function (rect1, rect2) {
    ...
    isOverlapingOtherDiamond: function (index, rect2) {
        for (var i = 0; i < index; i++) {
            ...
            if (this.isRectanglesOverlaping(rect1, rect2)) {
                return true;
            }
        }
        return false;
    ...
    update: function () {
        if (this.flagFirstMouseDown && !this.endGame) {
            ...
            for (var i = 0; i < AMOUNT_DIAMONDS; i++) {
                ...
                if (this.diamonds[i].visible && this.isRectanglesOverlaping(rectHorse, rectDiamond)) {
                    this.increaseScore();
